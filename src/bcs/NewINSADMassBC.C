...
#include "NewINSADMassBC.h"

registerMooseObject("slip_flowApp", NewINSADMassBC);

InputParameters
NewINSADMassBC::validParams()
{
...
NewINSADMassBC::NewINSADMassBC(const InputParameters & parameters)
...
ADReal
NewINSADMassBC::computeQpResidual()
{
  if (_has_vfn) {
