...
#include "TC_ADMomentumConservativeAdvection.h"

registerMooseObject("NavierStokesApp", TC_ADMomentumConservativeAdvection);

InputParameters
TC_ADMomentumConservativeAdvection::validParams()
{
...
TC_ADMomentumConservativeAdvection::TC_ADMomentumConservativeAdvection(const InputParameters & parameters)
...
ADRealTensorValue
TC_ADMomentumConservativeAdvection::precomputeQpResidual()
{
  auto vel = _u[_qp];
  ;
